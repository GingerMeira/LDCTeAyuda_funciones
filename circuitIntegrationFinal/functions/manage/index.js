/**
 * Cloud Functions to manage the LDC app
...
const ns = 'ldcTeAyuda_' + DOMAIN.split('//')[1];
...
async function authenticate () {
  try {
	...
	console.log(DOMAIN);
console.log(oauth2);
    const token = await oauth2.clientCredentials.getToken({scope: ['READ_USER_PROFILE','WRITE_USER_PROFILE','READ_CONVERSATIONS','WRITE_CONVERSATIONS','READ_USER'] })
